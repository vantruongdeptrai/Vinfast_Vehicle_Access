        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item">
                        <a href="{{route('list-parking-fee')}}" class="nav-link"><i
                                class="fa-solid fa-square-parking"></i> Parking Fee</a>
                    </div>
                    <div class="nav-item">
                        <a href="{{route('list-manage-parking')}}" class="nav-link"><i
                                class="fa-solid fa-list-check"></i> Manage parking</a>
                    </div>
                    <div class="nav-item">
                        <a href="{{route('qrcode')}}" class="nav-link"><i class="fa-solid fa-qrcode"></i> QR Code check
                            in</a>
                    </div>
                </div>
            </nav>
